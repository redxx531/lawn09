...
export default function ProjectApprovalList() {
            ...
            <div className="modal-content">
              ...
              <div className="modal-footer">
                ...
                <button 
                  ...
                  onClick={() => handleAction(currentProject.id, 'feature')}
                  disabled={actionLoading}
                >
                  {currentProject.isFeatured ? 'Remove from Featured' : 'Mark as Featured'}
                </button>
                <button 
                  type="button" 
